...
firewall-cmd --permanent --add-port=2377/tcp --add-port=9090/tcp --add-port=9100/tcp --add-port=161/udp --add-port=5000/tcp --add-port=8080/tcp --add-port=4789/udp --add-port=7946/tcp --add-port=7946/udp --zone=public
firewall-cmd --reload
